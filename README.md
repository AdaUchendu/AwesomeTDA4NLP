...
of TDA in NLP, yielding **137 papers** we comprehensively survey in this paper. Our findings categorize these efforts into theoretical and non-theoretical approaches. Theoretical
...
- **Topology aware optimization of soft prompts.** Zhenzhen_Huang, Chaoning Zhang, Jiaquan Zhang, Songbo Zhang, Haoyu Bian, Yibei Liu, Guo Chen, Qigan Sun, Chenghao Li, Kuien Liu, Caiyan Qin, Yang Yang. *OpenReview.net.* (2026) [[link]](https://openreview.net/forum?id=0yjmQKUiUr&referrer=%5Bthe+profile+of+Songbo+Zhang%5D%28%2Fprofile%3Fid%3D%7ESongbo_Zhang2%29)
...
- **LLM Security and Safety: Insights from Homotopy-Inspired Prompt Obfuscation.** Luis Lazo, Hamed Jelodar, Roozbeh Razavi-Far. *arXiv Preprint arXiv:2601.14528.* (2026) [[link]](https://arxiv.org/pdf/2601.14528)
- **Functional Homotopy: Smoothing Discrete Optimization via Continuous Parameters for LLM Jailbreak Attacks.** Zi Wang, Divyam Anshumaan, Ashish Hooda, Yudong Chen, Somesh Jha. *ICLR 2025.* (2025) [[link]](https://openreview.net/pdf?id=uhaLuZcCjH)
...
- **Topological Methods in Machine Learning: A Tutorial for Practitioners.** BARIS COSKUNUZER, CÜNEYT GÜRCAN AKÇORA. *arXiv arXiv:2409.02901* (2024) [[link]](https://arxiv.org/pdf/2409.02901?)
- **Topological Methods in Machine Learning: A Tutorial for Practitioners.** https://github.com/cakcora/TopologyForML
